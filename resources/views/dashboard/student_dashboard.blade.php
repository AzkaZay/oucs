                    ...
                    <div class="card bg-comman w-100">
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                ...
                                <div class="db-icon">
                                    <img src="{{URL::to('assets/img/icons/paper-roll.svg')}}" alt="Dashboard Icon">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card bg-comman w-100">
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                ...
                                <div class="db-icon">
                                    <img src="{{URL::to('assets/img/icons/card-access.svg')}}" alt="Dashboard Icon">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card bg-comman w-100">
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                ...
                                <div class="db-icon">
                                    <img src="{{URL::to('assets/img/icons/exam.svg')}}" alt="Dashboard Icon">
                                </div>
                            </div>
                        </div>
                    </div>
